...
{
    BOOST_CHECK(Nicknames::IsValidNickname("bit"));
    BOOST_CHECK(Nicknames::IsValidNickname("nonkyc"));
    BOOST_CHECK(Nicknames::IsValidNickname("shop123"));
    BOOST_CHECK(Nicknames::IsValidNickname("bit_dev"));
    BOOST_CHECK(Nicknames::IsValidNickname("mr_bit"));
...
BOOST_AUTO_TEST_CASE(validation_rejects_expected_examples)
{
    ...
    BOOST_CHECK(!Nicknames::IsValidNickname("_bit"));
    BOOST_CHECK(!Nicknames::IsValidNickname("bit_"));
    BOOST_CHECK(!Nicknames::IsValidNickname("bit__dev"));
...
BOOST_AUTO_TEST_CASE(normalization_is_lowercase_only)
{
    ...
    BOOST_CHECK_EQUAL(normalized, "bit_01");
