...
BOOST_AUTO_TEST_SUITE(bit_tests)
...
BOOST_AUTO_TEST_CASE(subsidy_test)
{
    ...
    BOOST_CHECK_EQUAL(GetBitBlockSubsidy(0, mainParams.GetConsensus(0), prevHash), 48 * COIN);
    BOOST_CHECK_EQUAL(GetBitBlockSubsidy(1168000, mainParams.GetConsensus(1168000), prevHash), 24 * COIN);
    BOOST_CHECK_EQUAL(GetBitBlockSubsidy(2336000, mainParams.GetConsensus(2336000), prevHash), 12 * COIN);
    BOOST_CHECK_EQUAL(GetBitBlockSubsidy(3504000, mainParams.GetConsensus(3504000), prevHash), 6 * COIN);
    BOOST_CHECK_EQUAL(GetBitBlockSubsidy(4672000, mainParams.GetConsensus(4672000), prevHash), 2 * COIN);
    BOOST_CHECK_EQUAL(GetBitBlockSubsidy(999999999, mainParams.GetConsensus(999999999), prevHash), 2 * COIN);
}

BOOST_AUTO_TEST_CASE(consensus_parameters_match_bit_mvp)
{
