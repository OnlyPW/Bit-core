...
/* Dogecoin 1.14.5: set the wallet's discard threshold to 1 BIT because that's what 97%
 ...
 */
/* Dogecoin 1.14.6: set the wallet's discard threshold to 0.01 BIT. Very network
