...
UniValue checknickname(const JSONRPCRequest& request)
{
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            "checknickname \"name\"\n"
            "\nValidate a nickname candidate and return the current BIT pricing tier.\n"
            "\nArguments:\n"
            ...
            "}\n"
            "\nExamples:\n"
            + HelpExampleCli("checknickname", "\"bit_dev\"")
            + HelpExampleRpc("checknickname", "\"bit_dev\"")
        );
    }
...
UniValue getnicknameinfo(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getnicknameinfo", "\"bit_dev\"")
            + HelpExampleRpc("getnicknameinfo", "\"bit_dev\"")
        );
    }
...
UniValue resolvenickname(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("resolvenickname", "\"bit_dev\"")
            + HelpExampleRpc("resolvenickname", "\"bit_dev\"")
        );
    }
...
UniValue registernickname(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 3) {
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("registernickname", "\"bit_dev\" \"0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798\" \"Ppb2G1hMPrU6wgGUohLaeNzfP4pQyd5udg\"")
            + HelpExampleRpc("registernickname", "\"bit_dev\", \"0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798\", \"Ppb2G1hMPrU6wgGUohLaeNzfP4pQyd5udg\"")
        );
    }
...
UniValue updatenickname(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2) {
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("updatenickname", "\"bit_dev\" \"Ppb2G1hMPrU6wgGUohLaeNzfP4pQyd5udg\"")
            + HelpExampleRpc("updatenickname", "\"bit_dev\", \"Ppb2G1hMPrU6wgGUohLaeNzfP4pQyd5udg\"")
        );
    }
...
UniValue transfernickname(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2) {
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("transfernickname", "\"bit_dev\" \"0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798\"")
            + HelpExampleRpc("transfernickname", "\"bit_dev\", \"0279be667ef9dcbbac55a06295ce870b07029bfcdb2dce28d959f2815b16f81798\"")
        );
    }
...
UniValue renewnickname(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("renewnickname", "\"bit_dev\"")
            + HelpExampleRpc("renewnickname", "\"bit_dev\"")
        );
    }
...
UniValue releasenickname(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1) {
        throw std::runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("releasenickname", "\"bit_dev\"")
            + HelpExampleRpc("releasenickname", "\"bit_dev\"")
        );
    }
