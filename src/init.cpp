...
{
    const std::string URL_SOURCE_CODE = "<https://bitcoin.org>";
    const std::string URL_WEBSITE = "<https://bitcoin.org>";
    ...
    const std::string COPYRIGHT_BIT = strprintf("Copyright (C) %i The BIT Core developers", COPYRIGHT_YEAR);
