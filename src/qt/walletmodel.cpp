...
static const unsigned char BIT_NICKNAME_MEMO_TYPE_NUMERIC = 0x01;
static const unsigned char BIT_NICKNAME_MEMO_TYPE_ALNUM = 0x02;
static const unsigned char BIT_NICKNAME_MEMO_TYPE_UTF8 = 0x03;
                             ...
                             std::string& errorOut)
{
    ...
    if (memoUtf8.size() > BIT_NICKNAME_MEMO_MAX_DATA_LEN) {
        errorOut = strprintf("Nickname memo is too long (max %d bytes)", BIT_NICKNAME_MEMO_MAX_DATA_LEN);
        return false;
    }
    ...
    unsigned char memoTypeByte = BIT_NICKNAME_MEMO_TYPE_UTF8;
    if (memoType == "numeric") {
        memoTypeByte = BIT_NICKNAME_MEMO_TYPE_NUMERIC;
        for (const unsigned char c : memoUtf8) {
            if (c < '0' || c > '9') {
        ...
        memoTypeByte = BIT_NICKNAME_MEMO_TYPE_ALNUM;
        for (const unsigned char c : memoUtf8) {
        ...
        memoTypeByte = BIT_NICKNAME_MEMO_TYPE_UTF8;
    } else {
