...
- **0,01 BIT pro Kilobyte** Transaktionsgebühr
- **0,01 BIT** Staubgrenze (Verwerfungsschwelle)
- **0,001 BIT** Ersetzung durch Gebühreninkremente
...
Gebühren werden über die genaue Größe einer Transaktion berechnet. Beispielsweise muss für eine 192-Byte-Transaktion nur eine BIT-Gebühr von `0,01 / 1000 * 192 = 0,00192` gezahlt werden.
...
genau auf die empfohlene Gebühr von **0,01 BIT/kB** festgelegt. Staubgrenzen werden durch
...
Die standardmäßige Mindesttransaktionsgebühr für Relay ist auf **0,001 BIT/kB** festgelegt,
...
- Das Hard Dust-Limit ist auf **0,001 BIT** festgelegt – Ausgaben unter diesem Wert sind
ungültig und werden abgelehnt.
- Das Soft Dust-Limit ist auf **0,01 BIT** festgelegt – beim Senden einer Transaktion mit Ausgaben
unter diesem Wert müssen für jede solche Ausgabe 0,01 BIT hinzugefügt werden, andernfalls
...
der Relay-Gebühr oder **0,0001 BIT** festgelegt.
