...
Gitian signatures for each release are added to https://github.com/bittoshimoto/gitian.sigs.

`gitian-build.sh` will create signatures inside `gitian-output/sigs/` folder. Create a pull request to [bit/gitian.sigs](https://github.com/bittoshimoto/gitian.sigs) to publish your signatures, the `.assert` and `.assert.sig` files.
