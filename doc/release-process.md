...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/bittoshimoto/gitian.sigs.git
...
- Upload zips and installers, as well as `SHA256SUMS.asc` from last step, to the bitcoin.org Github repo

- Create a [new GitHub release](https://github.com/bittoshimoto/bit/releases/new) with a link to the archived release notes.

- Update bitcoin.org version - Langerhans to do
