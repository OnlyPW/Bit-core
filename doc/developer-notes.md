...
Run with the -testnet option to run with "play bit" on the test network, if you
...
- BitMiner : Generates bit (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:bittoshimoto/Bit.git
